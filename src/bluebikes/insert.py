...
def _create_stations_table(connection):
    ...
    """
    with importlib.resources.path("bluebikes", "create_table_stations_spatial.sql") as spatial_stations_script:
        bluebikes.sql.execute_sql_script(connection, spatial_stations_script)
        connection.commit()
